  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex flex-row rounded-2xl border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 w-3/4 ml-auto bg-white dark:bg-black"
      >
        <div className="w-full bg-gray-100 h-4 rounded-full dark:bg-neutral-900" />
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Link
          to="https://x.com/dev_buoy?t=LfTZdBQfGZk2UW6SAfK_hA&s=09"
          target="__blank"
        >
          <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
            @ritog09
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Make your life simpler with brainDock
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Use BrainDock</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
